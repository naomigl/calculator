  ...
  return $as_sci_Map(namedExpressions.map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, namedExpressions$1) {
    return (function(x0$1$2) {
      ...
      if ((x0$1 !== null)) {
        ...
        $m_Lcalculator_Signal$();
        var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, exprSignal$1, namedExpressions$1$1, name$1) {
          return (function() {
            return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exprSignal$1.apply__O()), $as_sci_Map(namedExpressions$1$1.removed__O__sci_MapOps(name$1)))
          })
        })($this, exprSignal, namedExpressions$1, name));
